                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">
                        {{ totalventas.numero_clientes }}</span
                      >
                    </div>
                    <div class="col-auto">
                      <div
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">
                        {{ totalventas.numero_productos }}</span
                      >
                    </div>
                    <div class="col-auto">
                      <div
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">
                        {{ totalventas.numero_proveedores }}</span
                      >
                    </div>
                    <div class="col-auto">
                      <div
            ...
            <div class="col-xl-8 mb-5 mb-xl-0">
                <div class="card bg-gradient-default shadow">
                    ...
                    <div class="card-body">
                        <!-- Chart -->
                  <!-- {{series[0].data[0]}} -->
                  <small style="    color: rgba(0,0,0,0);">{{options}} {{series}} </small> 
            ...
            <div class="col-xl-4">
                <div class="card shadow">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h2 class="mb-0">Mejores clientes</h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                <tr v-for="item in totalventas['mejores_clientes'] ">
                                    <th scope="row">
                                        {{item.nombre}}
                                    </th>
            ...
            <div class="col-xl-8 mb-5 mb-xl-0">
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">Productos bajo stock</h3>
                            </div>
            ...
            <div class="col-xl-4">
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">Productos mas vendidos</h3>
                            </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                <tr v-for="item in totalventas['productos_mas_vendidos'] ">
                                    <th scope="row">
                                        {{item.nombre}}
                                    </th>
